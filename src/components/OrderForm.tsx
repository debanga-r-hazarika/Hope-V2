                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <input
                              ...
                              required
                              disabled={order?.is_locked ?? false}
                              className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-medium disabled:bg-gray-100 transition-all ${inventoryErrors[index] ? 'border-red-400 bg-red-50' : 'border-gray-300'
                                }`}
