                    ...
                    `}
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-wrap items-center gap-2 mb-3">
                                            <span
                                                className={`px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wider ${issue.priority === 'high'
                                            ...
                                            {issue.deadlineDate && (
                                                <span
                                                    className={`px-2 py-0.5 rounded-md text-[10px] font-medium border flex items-center gap-1 ${isOverdue(issue.deadlineDate)
