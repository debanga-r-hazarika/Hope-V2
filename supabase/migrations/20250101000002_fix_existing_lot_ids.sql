-- Fix existing lot IDs to ensure they follow the correct format
-- LOT-RM-000, LOT-RM-001, etc. for raw materials
-- LOT-RP-000, LOT-RP-001, etc. for recurring products

-- Function to regenerate lot IDs for raw materials
DO $$
DECLARE
  rec RECORD;
  new_lot_id TEXT;
...
-- Function to regenerate lot IDs for recurring products
DO $$
DECLARE
  rec RECORD;
  new_lot_id TEXT;
...
-- Verify no duplicates exist after fixing
DO $$
BEGIN
  IF EXISTS (
    SELECT lot_id, COUNT(*) 
